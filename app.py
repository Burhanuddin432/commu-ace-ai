        ...
        html.Div([
            ...
            html.Div([
                ...
                html.Div([
                    ...
                    html.Span("AI Analysis", className="sidebar-footer-item")
                ], className="mb-2"),
                html.Div([
...
def render_dashboard_page():
    return html.Div([
        ...
        html.Div([
            html.Div([
                html.I(className="fas fa-comments fa-3x mb-3", style={'color': '#06b6d4'}),
        ...
        html.Div([
            html.Div([
                ...
                dcc.RadioItems(
                    ...
                    value='Mixed',
                    className="mb-3",
                    labelStyle={'display': 'block', 'marginBottom': '8px', 'color': 'white'}
                ),
